...
main
  ...
  section.main-section
    article.main-section__overview
      h2 Overview
      p Self-taught developer with a background in digital marketing and technical writing seeking to transition to a **frontend UI developer role** with opportunities for professional growth in communications and information design, writing, and test-driven development.
            ...
            article.relevant-experience
              ...
              .relevant-experience__list
                .relevant-experience__item
                  ...
                  p.relevant-experinece__description Provides web consulting, training, and services to BSA | The Software Alliance and local businesses.
                .relevant-experience__item
                  .relevant-experience__years
...
.skills-item__graphic--percentage {
  background: #fff;
  height: 100%;
  color: #262427;
  text-align: center;
